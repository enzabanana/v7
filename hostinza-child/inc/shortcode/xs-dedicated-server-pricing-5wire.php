...
class XS_Dedicated_Server_Pricing_Widget_5wire extends Widget_Base {

    public function get_name() {
        return 'xs-dedicated-perver-pricing-5wire';
    }

    public function get_title() {
        return esc_html__( '5wire Dedicated server pricing', 'hostinza' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('5wire Dedicated server pricing', 'hostinza'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label' => esc_html__('Memory (RAM)', 'hostinza'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label' => esc_html__('Disks', 'hostinza'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'placeholder'   => esc_url('http://billing.5wire.co.uk'),
                'label_block'   => true,
            ]
        );
            ...
            [   
                ...
                'default' => [
                    ...
                    [
                        ...
                        'url' => esc_url('https://billing.5wire.co.uk'),
                    ]
                ],
    ...
    protected function render( ) {
        ...
        require HOSTINZA_SHORTCODE_DIR_STYLE .'/price-table/style5-5wire.php';
    }
