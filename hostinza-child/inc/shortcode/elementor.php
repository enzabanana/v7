...
class Xs_Shortcode{
    ...
    public function xs_shortcode_elements($widgets_manager){
        ...
        require_once HOSTINZA_SHORTCODE_DIR.'xs-pricing-table-5wire.php';
        require_once HOSTINZA_SHORTCODE_DIR.'xs-vps-slider.php';
        require_once HOSTINZA_SHORTCODE_DIR.'xs-dedicated-server-pricing.php';
        require_once HOSTINZA_SHORTCODE_DIR.'xs-dedicated-server-pricing-5wire.php';
        ...
        $widgets_manager->register_widget_type(new Elementor\XS_Pricing_Table_Widget_5wire());
        ...
        $widgets_manager->register_widget_type(new Elementor\XS_Dedicated_Server_Pricing_Widget_5wire());
